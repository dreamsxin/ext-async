...
void async_event_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent", "PollEvent", poll_event_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent", "TickEvent", tick_event_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent", "TimerEvent", timer_event_functions);
