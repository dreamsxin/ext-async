...
void async_ssl_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "TlsClientEncryption", async_tls_client_encryption_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "TlsServerEncryption", async_tls_server_encryption_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "TlsInfo", async_tls_info_functions);
