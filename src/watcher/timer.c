...
void async_timer_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent", "Timer", async_timer_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent", "Timeout", async_timeout_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent", "TimeoutException", empty_funcs);
