...
void async_socket_ce_register()
{
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "Socket", async_socket_functions);
	async_socket_ce = zend_register_internal_interface(&ce);
	
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "SocketStream", async_socket_stream_functions);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "Server", async_server_functions);
	async_server_ce = zend_register_internal_interface(&ce);

	zend_class_implements(async_server_ce, 1, async_socket_ce);

	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "SocketException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "SocketAcceptException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "SocketBindException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "SocketConnectException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "SocketDisconnectException", empty_funcs);
	...
	INIT_NS_CLASS_ENTRY(ce, "Concurrent\\Network", "SocketListenException", empty_funcs);
